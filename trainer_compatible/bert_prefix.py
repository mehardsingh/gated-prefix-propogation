...
class BertEncoder_Prefix(BertEncoder):
...
class BertModel_Prefix(BertModel):
    def __init__(self, config):
        super().__init__(config)
        self.encoder = BertEncoder_Prefix(config)
...
class BertForSequenceClassification_Prefix(BertForSequenceClassification):
    def __init__(self, config):
        super().__init__(config)
        self.bert = BertModel_Prefix(config)
